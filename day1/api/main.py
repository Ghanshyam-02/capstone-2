...
app = FastAPI(title="Merchant Settlement API", version=config.app_version())
repository = Repository()


def get_repo():
    """FastAPI "dependency": every endpoint gets the repository from here."""
    return repository
