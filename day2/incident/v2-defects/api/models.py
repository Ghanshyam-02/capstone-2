...
# ⚠️ INJECTED DEFECT D: Version 2 removed the 0..100 check from the API contract,
#    so an impossible settlement rate is returned with HTTP 200 instead of an error.
Percent = float
...
class SettlementSummary(BaseModel):
    ...
    settlement_gap: float               # KPI 3 (can be negative in this defective version)
